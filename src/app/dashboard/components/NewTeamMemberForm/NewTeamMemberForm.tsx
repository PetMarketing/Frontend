...
interface INewTeamMemberFormProps {
    session: ISession | null;
}

interface INewTeamMemberForm {
    name: string,
    department: string,
    position: string,
    image: string | null,
...
export default function NewTeamMemberForm({ session }: INewTeamMemberFormProps) {
    ...
    const submitHandler = async (values: INewTeamMemberForm, actions: FormikHelpers<INewTeamMemberForm>) => {
